...
- Ajustes (botón ⚙️ bajo Eventos): música de fondo (`public/audio/finfun.mp3`, en bucle; arranca con el primer toque por la política de autoplay de los navegadores) con interruptor y volumen, guardados en el dispositivo.
