...
- Insignias (`src/sim/badges.ts`, sección del Perfil): 14 familias con bronce/plata/oro (bellotas 100/500/1000, días jugados 7/30/100, dinero en el banco, lecciones, bonos, negocios, Fondo Isla, patrimonio, niveles, tormentas, visitas y préstamos a la Liebre, declaraciones, huerto). Las conseguidas se apuntan en `badges` de la partida (no se pierden si el número baja) y salta un toast al ganarlas; `daysPlayed` cuenta los días con el juego abierto.
