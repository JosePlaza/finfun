...
export const LESSONS: Lesson[] = [
  ...
  { id: 'ciclos', title: 'Ciclos y modas', icon: '🎢', body: 'La Cantera sube y baja con las obras de la isla, en un ciclo de tres años que se puede leer. El Taller de juguetes depende de las modas, que nadie puede predecir. Comprar lo que está arriba porque está arriba suele salir caro.' },
