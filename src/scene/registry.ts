...
export const BUILDINGS: BuildingDef[] = [
  // ───────── MUNDO 1 · La Isla ─────────
  { id: 'casa', name: 'Casa', world: 1, teaches: 'Aquí llega tu paga cada mes.', x: 11.5, z: 4.5, rotation: SE, footprint: 3.4, view: 'casa', icon: '🏠', camera: { frameW: 9, frameH: 6.5, elev: 0.55, side: 0.25, lookUp: 1.6 } },
  { id: 'banco', name: 'Banco', world: 1, teaches: 'Guarda tu dinero y lo hace crecer un poquito cada mes.', x: -8.0, z: 6.5, rotation: SE + 0.3, footprint: 3.8, view: 'banco', icon: '🏦', camera: { frameW: 10, frameH: 7, elev: 0.5, side: -0.2, lookUp: 2.0 } },
  { id: 'tienda', name: 'Tienda', world: 1, teaches: 'Donde el dinero se convierte en cosas.', x: 1.0, z: 11.0, rotation: SE + 0.4, footprint: 3.2, view: 'tienda', icon: '🏪', camera: { frameW: 8.5, frameH: 6, elev: 0.55, side: 0.2, lookUp: 1.5 } },
  { id: 'cofre', name: 'Cueva del cofre', world: 1, teaches: 'Tu ahorro, a buen recaudo dentro de la roca.', x: 8.5, z: 17.0, rotation: SE, footprint: 3.2, view: 'cofre', icon: '🪙', camera: { frameW: 11, frameH: 7, elev: 0.32, side: 0.1, lookUp: 1.3 } },
  { id: 'faro', name: 'Faro', world: 1, teaches: 'La casa de Doña Tortuga: su diario y sus consejos.', x: -12.5, z: -12.5, rotation: SE, footprint: 3.6, view: 'faro', icon: '🐢', camera: { frameW: 10, frameH: 10, elev: 0.45, side: 0.35, lookUp: 3.6 } },
  // ───────── MUNDO 2 · El Ayuntamiento ─────────
  { id: 'ayuntamiento', name: 'Ayuntamiento', world: 2, teaches: 'Emite bonos: le prestas dinero y te paga un cupón fijo.', x: -6.0, z: -4.5, rotation: SE, footprint: 3.8, icon: '🏛️' },
  { id: 'hacienda', name: 'Hacienda', world: 2, teaches: 'Don Búho se lleva una parte de lo que ganas y hace la declaración.', x: -15.0, z: -0.5, rotation: Math.PI / 2, footprint: 3.0, icon: '🦉' },
  { id: 'escuela', name: 'Escuela', world: 2, teaches: 'Los carnés de inversor y las lecciones de Doña Tortuga.', x: 2.5, z: 1.5, rotation: SE, footprint: 3.2, icon: '🏫' },
  // ───────── MUNDO 3 · El Mercado ─────────
  { id: 'mercado', name: 'Mercado de acciones', world: 3, teaches: 'Compra trozos de los negocios de la isla.', x: 9.0, z: -5.5, rotation: SE, footprint: 3.8, icon: '📈' },
  { id: 'panaderia', name: 'Panadería', world: 3, teaches: 'Negocio estable que reparte dividendo cada trimestre.', x: 19.0, z: -4.5, rotation: SE + 0.6, footprint: 2.8, icon: '🥖' },
  { id: 'heladeria', name: 'Heladería', world: 3, teaches: 'Gana en verano y cierra en invierno: un negocio de temporada.', x: -6.5, z: 16.0, rotation: SE - 0.3, footprint: 2.6, icon: '🍦' },
  { id: 'puerto', name: 'Puerto pesquero', world: 3, teaches: 'Los barcos ganan mucho… si no hay tormenta.', x: 16.5, z: 12.5, rotation: SE, footprint: 2.8, icon: '🎣' },
  { id: 'astillero', name: 'Astillero', world: 3, teaches: 'No reparte dividendo: lo reinvierte todo para crecer.', x: 21.5, z: 4.5, rotation: SE - 0.6, footprint: 3.4, icon: '⚓' },
  // ───────── MUNDO 4 · La Tormenta ─────────
  { id: 'molino', name: 'Molino', world: 4, teaches: 'Energía regulada: poco crecimiento, dividendo seguro.', x: -20.5, z: -7.5, rotation: SE, footprint: 2.6, icon: '🌬️' },
  { id: 'posada', name: 'Posada del Puerto', world: 4, teaches: 'Vive del turismo de verano.', x: -4.5, z: -18.0, rotation: 0, footprint: 3.2, icon: '🛎️' },
  { id: 'granja', name: 'Granja', world: 4, teaches: 'La cosecha de otoño manda: plagas y sequías.', x: 7.5, z: -17.5, rotation: 0.2, footprint: 3.4, icon: '🌾' },
  { id: 'cantera', name: 'Cantera', world: 4, teaches: 'Gana cuando la isla construye: un negocio cíclico.', x: 16.0, z: -13.0, rotation: SE, footprint: 3.0, icon: '⛏️' },
  { id: 'taller', name: 'Taller de juguetes', world: 4, teaches: 'Modas: un año arrasa y otro no.', x: -21.0, z: 6.5, rotation: Math.PI / 2, footprint: 3.0, icon: '🧸' },
  { id: 'observatorio', name: 'Observatorio', world: 4, teaches: 'Ciencia: crece muchísimo o nada. Alto riesgo.', x: 1.0, z: -11.0, rotation: SE, footprint: 2.6, icon: '🔭' },
  { id: 'fondo', name: 'Casa del Fondo Isla', world: 4, teaches: 'Un trocito de todos los negocios a la vez.', x: -15.0, z: 13.5, rotation: SE + 0.7, footprint: 3.2, icon: '🧺' },
]
