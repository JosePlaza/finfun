...
export const BUILDINGS: BuildingDef[] = [
  ...
  { id: 'escuela', name: 'Escuela', world: 2, teaches: 'Los carnés de inversor y las lecciones de Doña Tortuga.', x: 1.0, z: -0.5, rotation: SE, footprint: 3.2, view: 'escuela', icon: '🏫', about: 'Lecciones cortas de Doña Tortuga sobre cada idea del juego. Cada una termina con una pregunta: si la aciertas, queda aprendida y ganas un carné de inversor; si fallas, mañana lo intentas otra vez.' },
  // ───────── MUNDO 3 · El Mercado ─────────
