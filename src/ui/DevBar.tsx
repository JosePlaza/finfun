...
export function DevBar() {
  ...
  return (
    <div className="absolute left-3 top-[calc(env(safe-area-inset-top)+70px)] z-10 flex items-center gap-1 bg-ink/80 text-white rounded-xl px-2 py-1 text-xs font-mono">
